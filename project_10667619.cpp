...
cout << "*********************************************************************************************************************" << endl;
cout << "*********************************************************************************************************************" << endl;
cout << "**										MAJESTY HILLS INSTITUTE OF TECHNOLOGY										**" << endl;
cout << "**										  United State of America, Virginia											**" << endl;
cout << "**																													**" << endl;
cout << "**																													**" << endl;
cout << "**																													**" << endl;
cout << "**																													**" << endl;
cout << "**		P. O. Box 45																								**" << endl;
cout << "**		Virginia - US.																								**" << endl;
cout << "**																													**" << endl;
cout << "**		CONTACT:																									**" << endl;
cout << "**		+144 5071 3162 / +144 5071 3172										 										**" << endl;
cout << "**																													**" << endl;
cout << "**											'Integrity is our priority'												**" << endl;
cout << "*********************************************************************************************************************" << endl;
cout << "*********************************************************************************************************************" << endl;
cout << "---------------------------------------------------------------------------------------------------------------------" << endl;
cout << endl;
...
if(intro=="1")
 {   while(stdMenu<=10)
  ...
  if(stdIntro=="1")
    ...
    cin>>cNo[i-1];
    cout<<"Enter the course codes(after each course code, press the enter key)\n";
    for(r=0; r<cNo[i-1]; r++){
    ...
    cout<<"You can enter any other key to get back to main menu\n";
    cin>>addStd;
    if(addStd=='p')
     {   system("cls");
...
cout<<k.courses[r][i-1]<<"                                                    \t            "<<k.credit[r][i-1]<<"  \t   "<<k.gpa[r][i-1]<<"  \t   "<<k.gpt[r][i-1]<<endl;
    ...
    { while(x<=10)
          { system("cls");
           cout<<"Enter the number of the student whose details you want to edit( e.g. enter 1 for one student and so on)\n";
    ...
    { while(e<=10)
          { system("cls");
           cout<<"Enter the number of the student whose records you want to delete( e.g.enter 1 for one student and so on)\n";
           cin>>del;
           totGpt[del-1]=0;
           totCredit[del-1]=0;
           GPA[del-1]=0;
